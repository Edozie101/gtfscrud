...
module.exports = function (app) {
  ...
  const routes = new Schema({
    ...
    agency_id: {type: ObjectId, required: false},
    route_short_name: {type: String, required: true},
    route_long_name: {type: String, required: true},
    route_type: {type: Number, required: true},
    route_desc: {type: String, required: false},
    route_url: { type: String, required: false},
    route_color: {type: String, required: false},
    route_text_color: {type: String, required: false},
    route_sort_order: { type: Number, required: false}
