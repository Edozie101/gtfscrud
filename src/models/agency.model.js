// agency-model.js - A mongoose model
// 
...
module.exports = function (app) {
  ...
  const agency = new Schema({
    agency_id: {type: Number, required: false},
    agency_name: {type: String, required: true},
    agency_url: {type: String, required: true},
    agency_timezone: {type: String, required: true},
    agency_lang: {type: String, required: false},
    agency_phone: {type: String, required: false},
    agency_fare_url: {type: String, required: false},
    agency_email: {type: String, required: false}
  }, {
    timestamps: true
  });

  return mongooseClient.model('agency', agency);
};
...
// agency_url	Required	The agency_url field contains the URL of the transit agency. The value must be a fully qualified URL that includes http:// or https://, and any special characters in the URL must be correctly escaped.
